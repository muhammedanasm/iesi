...
//   return (
//     <section className="py-24 bg-[#F5F4F2] overflow-hidden relative">
//       {/* 1. HEADER */}
//       <div className="text-center mb-16 px-6">
//         <div className="mb-6 inline-flex items-center overflow-hidden bg-white border border-black/5 rounded-full py-1.5 px-6 w-fit mx-auto">
//           <span className="text-[9px] tracking-[0.4em] font-bold text-[#C69A59] uppercase">
//             Trusted Feedback
//           </span>
//         </div>
//         <h2 className="text-4xl md:text-6xl font-serif text-[#161616]">
//           What Clients Are Saying
//         </h2>
//       </div>

//       {/* 2. SWIPER SLIDER WITH PERFECT ARROWS */}
//       <div className="max-w-[1450px] mx-auto px-10 md:px-20 relative">
//         {/* Arrows Container - Correctly Positioned */}
//         <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 z-30 flex justify-between pointer-events-none px-4 md:px-8">
//           <button className="testi-prev-btn w-12 h-12 rounded-full border border-black/10 flex items-center justify-center cursor-pointer bg-white hover:bg-[#161616] hover:text-white transition-all duration-500 shadow-sm pointer-events-auto">
//             <svg
//               width="18"
//               height="18"
//               viewBox="0 0 24 24"
...
//             </svg>
//           </button>
//           <button className="testi-next-btn w-12 h-12 rounded-full border border-black/10 flex items-center justify-center cursor-pointer bg-white hover:bg-[#161616] hover:text-white transition-all duration-500 shadow-sm pointer-events-auto">
//             <svg
//               width="18"
//               height="18"
//               viewBox="0 0 24 24"
...
//             <SwiperSlide key={i}>
//               <div className="bg-white p-10 md:p-12 rounded-[40px] shadow-sm flex flex-col min-h-[420px] relative border border-black/[0.03]">
//                 {/* Stars */}
//                 <div className="flex gap-1.5 mb-8 text-[#C69A59]">
//                   {[...Array(5)].map((_, index) => (
//                     <span
//                       key={index}
//                       className={index < t.stars ? "opacity-100" : "opacity-20"}
//                     >
//                       ★
//                     </span>
//                   ))}
...
//                 <p className="text-[#585858] text-[17px] font-light leading-relaxed mb-10 italic">
//                   {t.text}
//                 </p>

//                 <div className="flex items-center justify-between mt-auto">
//                   <div className="flex flex-col">
//                     <span className="text-xl font-serif font-bold text-[#161616]">
//                       {t.name}
//                     </span>
//                     <span className="text-[10px] uppercase tracking-widest text-[#C69A59] font-black mt-1">
//                       / {t.role}
//                     </span>
//                   </div>
//                   <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-[#F5F4F2] shadow-sm">
//                     <img
//                       src={t.image}
//                       alt={t.name}
...
//                 <span
//                   className="text-[6rem] md:text-[10rem] font-serif font-bold text-transparent uppercase tracking-tighter px-10"
