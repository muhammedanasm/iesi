...
//   useEffect(() => {
//     // സെഷനിൽ 'hasLoaded' ഉണ്ടോ എന്ന് നോക്കുന്നു
//     const hasLoaded = sessionStorage.getItem("hasLoaded");

//     if (hasLoaded) {
//       // നേരത്തെ കണ്ടിട്ടുണ്ടെങ്കിൽ ലോഡർ കാണിക്കണ്ട
//       setIsLoading(false);
//     } else {
//       // ആദ്യമായിട്ടാണെങ്കിൽ ലോഡർ കാണിക്കണം
//       // Preloader-ന്റെ ഉള്ളിലെ onComplete വഴി ഇത് പിന്നീട് false ആകും
//     }
//   }, []);
...
//       // സെഷനിൽ സേവ് ചെയ്യുന്നു, ഇനി പേജ് മാറിയാൽ ഇത് കാണിക്കില്ല
